# 06-view-single-article-high

**As a** website visitor (logged in or not)  
**I want to** read a complete article with its tags and category  
**So that** I can understand the content and discover related articles
